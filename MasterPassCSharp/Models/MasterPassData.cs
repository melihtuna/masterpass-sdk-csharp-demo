...
namespace MasterCard.WalletWebContent.Models
{
    public class MasterPassData
    {
        ...
        public MasterPassData()
        {
            ...
            this.ExpressCheckoutUrl = ConfigurationManager.AppSettings["ExpressCheckoutUrl"];
            ...
            this.ExpressCallbackPath = ConfigurationManager.AppSettings["ExpressCallbackPath"];
            ...
            this.ProdConsumerKey = ConfigurationManager.AppSettings["ProdConsumerKey"];
            ...
            this.ProdKeystorePath = ConfigurationManager.AppSettings["ProdKeystorePath"];
        ...
        [DisplayName("Prod Consumer Key: ")]
        public string ProdConsumerKey { get; set; }

        public string ConsumerWalletId { get; set; }
        public string ExpressCallbackPath { get; set; }
        public string ExpressCallbackUrl
        {
            get
            {
                return this.CallbackDomain + this.ExpressCallbackPath;
            }
        }

        [DisplayName("Express Checkout URL: ")]
        public string ExpressCheckoutUrl { get; set; }
        public string ExpressCheckoutRequest { get; set; }
        public string ExpressCheckoutResponse { get; set; }

        public bool ExpressSecurityRequired { get; set; }

        [DisplayName("Keystore Path: ")]
        public string KeystorePath { get; set; }

        [DisplayName("Prod Keystore Path: ")]
        public string ProdKeystorePath { get; set; }
        ...
        public string MerchantUploadRequest { get; set; }
        public string MerchantUploadValidateResponse { get; set; }
        public string MerchantUploadResponse { get; set; }
    }
}